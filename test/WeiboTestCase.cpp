...
{
	CPPUNIT_ASSERT(gWeiboHelper->getWeiboMethod()->getSearchSuggestionsSchool("清华") == WRC_OK);
...
{
	CPPUNIT_ASSERT(gWeiboHelper->getWeiboMethod()->getSuggestionsUsersByStatus("天气不错") == WRC_OK);
